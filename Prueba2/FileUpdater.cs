...
namespace Prueba2
{
    ...
    public class FileUpdater
    {
        ...
        public string UpdateFiles(string sourceFolder, string targetFolder,string commant ,string backupDir = null)
        {
            ...
            catch (Exception ex)
            {
                if (createBackup)
                {
                    ...
                    var rollbackError = this.UpdateFiles(backupDir, targetFolder,ExecuteCommandExtension);
        ...
        private void ExecuteBats(string file, string fileName, string targetRelativeDirectory, bool createBackup, string backupDir, string extension)
        {
            ...
            if (createBackup)
            {
                string finalpath=backupDir+"\\"+fileName+extension;
